        ...
        <div className="homepage-container">
            ...
            <div className="about">
                <p>
                  ...
                  notation would be referred to as Linear Time(O(n)). You can refer to the <a href="https://www.bigocheatsheet.com/" rel="noopener noreferrer" target="_blank">Big-O Cheat Sheet </a> 
                  for more details.
                </p>
            </div>
            </div>
